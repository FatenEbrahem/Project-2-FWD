...
public class P01_register extends Hooks{
    ...
    public WebElement dayDateField() {
        WebElement dayField = Hooks.driver.findElement(By.className("DateOfBirthDay"));
        return dayField;
    }


    public WebElement monthDateField(){
        WebElement monthField = Hooks.driver.findElement(By.className("DateOfBirthMonth"));
        return monthField;
    }

    public WebElement yearDateField(){
        WebElement yearField = Hooks.driver.findElement(By.className("DateOfBirthYear"));
        return yearField;
    }
